...
This plugin is self-contained and uses the actual FIGlet binary, built from the official distribution on Linux with x86-64 architecture.  
*Note that this means the plugin will only work if your Mattermost server is also running Linux with x86-64.*
